...
export default function Register() {
  ...
  let myValidation = yup.object().shape({
    name: yup
      ...
      .max(10, "Name should be less than 10 letters"),
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 py-24">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <h1 className="font-bold text-5xl text-center my-6 text-emerald-700">
          Register Now!
        </h1>
          ...
          <div className="relative z-0 w-full mb-5 group">
            ...
            {formik.errors.phone && formik.touched.phone ? (
              ...
              >
                ...
                <span className="sr-only">Info</span>
                <div>
                  <span className="font-medium">Alert!</span> {formik.errors.phone}
                </div>
              </div>
            ) : null}
          </div>
